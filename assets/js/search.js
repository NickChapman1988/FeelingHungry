               ...
               var newRecipe = new XMLHttpRequest();
                ...
                newRecipe.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        el.innerHTML += `<div class="col-md-6 col-lg-4 recipe-each hvr-grow"><a href="${recipe.spoonacularSourceUrl}" target="_blank"><h4> ${recipe.title}</h4> <img src=${recipe.image} class="img-fluid"><p>Click for the full recipe!</p></a></div>`;   
                    }
                };
            });
        }
